...
ALL_CONFIG_VARIABLES = [
    ...
    DB_URI, DB_URI_ENV_VAR, DB_DIALECT, DB_DRIVER, DB_USERNAME, DB_PASSWORD,
    DB_HOST, DB_PORT, DB_DATABASE, DB_INSTANCE_RELATIVE_CONFIG,
    AUTH0_CLIENT_ID, AUTH0_CLIENT_SECRET, AUTH0_CALLBACK_URL,
    AUTH0_LOGGED_OUT_URL, AUTH0_DOMAIN, AUTH0_AUDIENCE,
    NON_INTERACTIVE_CLIENT_ID, NON_INTERACTIVE_CLIENT_SECRET,
    SECRET_KEY, ALGORITHMS, BASE_URL,
